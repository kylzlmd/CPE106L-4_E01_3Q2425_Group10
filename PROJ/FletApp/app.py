...
def main(page: ft.Page):
    ...
    page.window_width = 400  # Smaller width for login/register
...
def assign_schedule_ui(page):
    ...
    def go_back(e):
        open_dashboard(page, "admin")  # Fully reinitialize the admin menu
    ...
    page.add(
        ft.Column([
            ...
            message,
            ft.ElevatedButton("Back", on_click=go_back)  # Use go_back instead of lambda
        ], alignment=ft.MainAxisAlignment.CENTER)
    )
    page.update()
